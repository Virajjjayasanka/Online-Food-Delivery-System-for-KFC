...
@Component({
  selector: 'app-mange-order-beverages',
  templateUrl: './mange-order-beverages.component.html',
  styleUrls: ['./mange-order-beverages.component.css']
})
export class MangeOrderBeveragesComponent implements OnInit {
  ...
  selecteRiderGetOrders: RidergetOrder = new RidergetOrder();
  ...
  constructor(private orderService: OrdersService, private itemService : ItemServiceService ,private selectItemService : SelectItemService, private cookieService: CookieService, private customer: ClientCustomerService, private riderGetOrdersService : RiderGetOrdersService) { }
...
//   .subscribe(result => {
//     if (result) {
//       alert(" Your Order has been update successfully");
//     } else {

//       alert(" Your Order has been update Unsuccessfully");
//     }
