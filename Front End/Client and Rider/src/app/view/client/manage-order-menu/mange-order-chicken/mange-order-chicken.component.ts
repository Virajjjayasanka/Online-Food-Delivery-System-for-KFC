...
@Component({
  selector: 'app-mange-order-chicken',
  templateUrl: './mange-order-chicken.component.html',
  styleUrls: ['./mange-order-chicken.component.css']
})
export class MangeOrderChickenComponent implements OnInit {
