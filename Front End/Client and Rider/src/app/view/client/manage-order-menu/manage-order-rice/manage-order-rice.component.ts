...
@Component({
  selector: 'app-manage-order-rice',
  templateUrl: './manage-order-rice.component.html',
  styleUrls: ['./manage-order-rice.component.css']
})
export class ManageOrderRiceComponent implements OnInit {
